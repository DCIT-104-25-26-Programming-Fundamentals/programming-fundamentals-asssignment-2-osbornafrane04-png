...
// Function to validate the score and return the corresponding letter grade.
// Returns '\0' if score is outside the range 0 to 100.
char getGrade(double score) {
    if (score < 0 || score > 100) {
        return '\0'; // Invalid score indicator
    } else if (score >= 80) {
        return 'A';
    } else if (score >= 70) {
        return 'B';
